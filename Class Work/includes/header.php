    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="page7.php">Page 7</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="page8.php">Page 8</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="page9.php">Page 9</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="page10.php">Page 10</a>
                </li>
